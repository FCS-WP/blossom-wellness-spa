		...
		<div class="nova-blog-posts post-display-block">
			...
			<div class="nova-blog-posts__content<?php if(has_post_thumbnail()): ?> has-thumbnail<?php endif?>">
				...
				<div class="nova-blog-posts__readmore-wrap">
					<a class="nova-blog-posts__readmore link-animation-icon" href="<?php echo(esc_url(get_permalink())); ?>"><?php esc_html_e( 'Read more', 'robeto') ?><i class="inova ic-arrow-right"></i></a>
				</div>
			</div>
		</div>
</article>
