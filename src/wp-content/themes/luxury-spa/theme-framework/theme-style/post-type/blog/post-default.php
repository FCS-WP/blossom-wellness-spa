...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_post_default'); ?>>
	<div class="cmsmasters_post_cont">
		...
		if ($cmsmasters_post_format == 'image') {
			...
			if ((!empty($empty_test_array) && sizeof($cmsmasters_post_images) > 0) || has_post_thumbnail()) {
				echo '<div class="cmsmasters_media_wrap">';
					...
					luxury_spa_post_type_slider(get_the_ID(), $cmsmasters_post_images, $cmsmasters_image_thumb_size, $slider_data);
			...
			echo '<div class="cmsmasters_media_wrap">';
				...
				luxury_spa_thumb(get_the_ID(), $cmsmasters_image_thumb_size, true, false, false, false, false, true, false);
		...
		echo '<div class="cmsmasters_post_cont_inner">';
			...
			luxury_spa_post_heading(get_the_ID(), 'h2');
