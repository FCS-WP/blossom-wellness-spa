...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_post_timeline'); ?>>
	...
	if ($date) {
		echo '<div class="cmsmasters_post_date_wrap entry-meta">';
			...
			luxury_spa_get_post_date('page', 'timeline');
			...
			if ($cmsmasters_post_format == 'image') {
				...
				if (sizeof($cmsmasters_post_images) > 0 || has_post_thumbnail()) {
					echo '<div class="cmsmasters_media_wrap">';
						...
						luxury_spa_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'post-thumbnail', $slider_data);
				...
				echo '<div class="cmsmasters_media_wrap">';
					...
					luxury_spa_thumb(get_the_ID(), 'post-thumbnail', true, false, true, false, true, true, false);
