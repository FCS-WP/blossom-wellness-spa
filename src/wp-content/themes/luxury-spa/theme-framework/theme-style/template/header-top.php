...
if ($cmsmasters_option['luxury-spa' . '_header_top_line']) {
	echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['luxury-spa' . '_header_top_height']) . '">' . 
		'<div class="header_top_outer">' . 
			'<div class="header_top_inner">';
				...
				if (
					$cmsmasters_option['luxury-spa' . '_header_top_line_add_cont'] == 'social' && 
					isset($cmsmasters_option['luxury-spa' . '_social_icons'])
				) {
					luxury_spa_social_icons();
				} elseif (
					$cmsmasters_option['luxury-spa' . '_header_top_line_add_cont'] == 'nav' && 
				...
				if ($cmsmasters_option['luxury-spa' . '_header_top_line_short_info'] !== '') {
					echo '<div class="header_top_meta">' . 
						'<div class="meta_wrap">' . 
							stripslashes($cmsmasters_option['luxury-spa' . '_header_top_line_short_info']) . 
						'</div>' . 
					'</div>';
				} 
