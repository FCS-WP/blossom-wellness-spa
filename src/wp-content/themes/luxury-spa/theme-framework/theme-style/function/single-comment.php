...
function luxury_spa_mytheme_comment($comment, $args, $depth) {
    ?>
			...
			<div class="comment-content cmsmasters_comment_item_cont">
				...
				<div class="cmsmasters_comment_item_cont_info">
					...
					comment_reply_link(array_merge($args, array( 
						...
						'reply_text' => esc_attr__('Reply', 'luxury-spa') 
					)));
					
					
					edit_comment_link(esc_attr__('Edit', 'luxury-spa'), '', '');
					?>
				</div>
				<div class="cmsmasters_comment_item_content">
					...
					if ($comment->comment_approved == '0') {
						echo '<p>' . 
							'<em>' . esc_html__('Your comment is awaiting moderation.', 'luxury-spa') . '</em>' . 
						'</p>';
					}
					?>
				</div>
