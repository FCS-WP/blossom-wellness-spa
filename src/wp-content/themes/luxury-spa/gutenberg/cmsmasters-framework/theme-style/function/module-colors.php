...
function luxury_spa_gutenberg_module_colors($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Colors Scheme Rules ******************/
	...
	{$editor} div.wp-block ul > li:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_border']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform blockquote:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_link']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform blockquote p {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_heading']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead td { 
		" . cmsmasters_color_css('background-color', $cmsmasters_option['luxury-spa' . '_default_link']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead th,
	{$editor} .wp-block-freeform.mce-content-body > table thead td { 
		" . cmsmasters_color_css('border-color', $cmsmasters_option['luxury-spa' . '_default_link']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead th,
	{$editor} .wp-block-freeform.mce-content-body > table thead td {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_bg']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform table tbody tr td {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['luxury-spa' . '_default_border']) . "
	}
	
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) th,
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['luxury-spa' . '_default_alternate']) . "
	}
	/* Finish Table Colors */
...
/***************** Start Gutenberg Module General Colors Scheme Rules ******************/
	...
	{$editor} .wp-block-latest-comments .wp-block-latest-comments__comment-date {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_color']) . "
	}
	...
	.editor-styles-wrapper div.wp-block .wp-block-freeform.block-library-rich-text__tinymce a:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_hover']) . "
	}
	
	.editor-styles-wrapper select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['luxury-spa' . '_default_hover']) . "
	}
	...
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['luxury-spa' . '_default_heading']) . "
	}
	
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['luxury-spa' . '_default_heading']) . "
	}
	...
	body .editor-styles-wrapper,
	.editor-styles-wrapper select {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['luxury-spa' . '_default_bg']) . "
	}
	...
	{$editor} .wp-block-separator:not(.is-style-dots):before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['luxury-spa' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['luxury-spa' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['luxury-spa' . '_default_hover']) . "
	}
...
add_filter('luxury_spa_theme_colors_secondary_filter', 'luxury_spa_gutenberg_module_colors');
