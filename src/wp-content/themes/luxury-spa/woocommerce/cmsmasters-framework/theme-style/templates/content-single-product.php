...
if(!function_exists('luxury_spa_related_products_args')) {
	function luxury_spa_related_products_args($args) {
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
		...
		<div class="summary entry-summary cmsmasters_product_right_column">
			<div class="cmsmasters_product_title_info_wrap">
				<div class="cmsmasters_product_info_wrap">
					...
					luxury_spa_woocommerce_rating('cmsmasters_theme_icon_star_empty', 'cmsmasters_theme_icon_star_full');
					?>
				</div>
	...
	<?php
		if ($cmsmasters_layout != 'fullwidth') {
			add_filter('woocommerce_output_related_products_args', 'luxury_spa_related_products_args');
		}
