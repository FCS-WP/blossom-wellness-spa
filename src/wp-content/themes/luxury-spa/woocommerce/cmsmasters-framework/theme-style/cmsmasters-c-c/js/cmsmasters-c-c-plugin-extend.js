...
cmsmastersShortcodes.cmsmasters_product_category = {
	...
	fields : { 
		...
		category : { 
			...
			descr : 	cmsmasters_woocommerce_shortcodes.product_category_field_cat_descr + "<br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_woocommerce_shortcodes.product_category_field_cat_descr_note + "</span>", 
			def : 		'', 
			required : 	true, 
			width : 	'half', 
			choises : 	luxury_spa_composer_product_cat() 
		}, 
		// Order By
		orderby : { 
			type : 		'select', 
