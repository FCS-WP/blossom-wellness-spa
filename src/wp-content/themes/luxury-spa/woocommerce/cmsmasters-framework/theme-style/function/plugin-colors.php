...
function luxury_spa_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_product_category_shortcode.puzzle .cmsmasters_products .cmsmasters_product .cmsmasters_product_inner {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['luxury-spa' . '_' . $scheme . '_bg']) . ", 0.95);
	}
	...
	{$rule}.shop_table.order_details tfoot tr:last-child th, 
	{$rule}.shop_table.order_details tfoot tr:last-child td, 
	{$rule}.woocommerce-MyAccount-content .woocommerce-EditAccountForm fieldset, 
	{$rule}.woocommerce-MyAccount-content .woocommerce-EditAccountForm fieldset legend, 
	{$rule}.woocommerce-info, 
	{$rule}.woocommerce-message, 
...
add_filter('luxury_spa_theme_colors_secondary_filter', 'luxury_spa_woocommerce_colors');
