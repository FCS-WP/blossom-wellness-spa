...
<?php luxury_spa_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php luxury_spa_get_page_classes($cmsmasters_option); ?>hfeed site">
...
luxury_spa_page_heading();

list($cmsmasters_layout, $cmsmasters_page_scheme) = luxury_spa_theme_page_layout_scheme();
