...
if (!function_exists('luxury_spa_get_custom_page_meta_fields')) {
function luxury_spa_get_custom_page_meta_fields() {
	$cmsmasters_option = luxury_spa_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['luxury-spa' . '_layout']) && $cmsmasters_option['luxury-spa' . '_layout'] !== '') ? $cmsmasters_option['luxury-spa' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['luxury-spa' . '_header_overlaps']) && $cmsmasters_option['luxury-spa' . '_header_overlaps'] !== '') ? (($cmsmasters_option['luxury-spa' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'luxury-spa'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'luxury-spa'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'luxury-spa'), 
