...
if (!function_exists('luxury_spa_get_custom_profile_meta_fields')) {
function luxury_spa_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['luxury-spa' . '_profile_post_title']) && $cmsmasters_option['luxury-spa' . '_profile_post_title'] !== '') ? (($cmsmasters_option['luxury-spa' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['luxury-spa' . '_profile_post_details_title']) && $cmsmasters_option['luxury-spa' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['luxury-spa' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['luxury-spa' . '_profile_post_share_box']) && $cmsmasters_option['luxury-spa' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['luxury-spa' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'luxury-spa'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'luxury-spa'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'luxury-spa'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'luxury-spa'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'luxury-spa'), 
			'desc'	=> '', 
