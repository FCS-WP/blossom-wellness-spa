...
if (!function_exists('luxury_spa_get_custom_post_meta_fields')) {
function luxury_spa_get_custom_post_meta_fields() {
	$cmsmasters_option = luxury_spa_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['luxury-spa' . '_blog_post_layout']) && $cmsmasters_option['luxury-spa' . '_blog_post_layout'] !== '') ? $cmsmasters_option['luxury-spa' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['luxury-spa' . '_blog_post_title']) && $cmsmasters_option['luxury-spa' . '_blog_post_title'] !== '') ? (($cmsmasters_option['luxury-spa' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['luxury-spa' . '_blog_post_share_box']) && $cmsmasters_option['luxury-spa' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['luxury-spa' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['luxury-spa' . '_blog_post_author_box']) && $cmsmasters_option['luxury-spa' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['luxury-spa' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['luxury-spa' . '_blog_more_posts_box'])) ? $cmsmasters_option['luxury-spa' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'luxury-spa'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'luxury-spa'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'luxury-spa'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'luxury-spa'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'luxury-spa'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'luxury-spa'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'luxury-spa') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'luxury-spa'), 
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'luxury-spa'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'luxury-spa'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'luxury-spa'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'luxury-spa'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'luxury-spa'), 
			'desc'	=> '', 
